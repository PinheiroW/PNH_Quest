				...
				class Health
				{
					...
					healthLevels[]=
					{
						
						{
							...
							{
								"ND_MISSIONS\data\GeigerCounter\data\geiger_counter.rvmat"
							}
						},
						
						{
							...
							{
								"ND_MISSIONS\data\GeigerCounter\data\geiger_counter_damage.rvmat"
							}
						},
						
						{
							...
							{
								"ND_MISSIONS\data\GeigerCounter\data\geiger_counter_destruct.rvmat"
							}
						}
					};
				};
