...
class alpTraderMenu extends UIScriptedMenu
{
	...
	override Widget Init()
	{
		...
		layoutRoot = GetGame().GetWorkspace().CreateWidgets("PNH_Missions/gui/layouts/GUI_trader.layout");
		...
		//ICONS UPDATE
		ImageWidget.Cast( layoutRoot.FindAnyWidget("BankBalanceIcon") ).LoadImageFile(0,"PNH_Missions/gui/images/BankAccount.paa");
		ImageWidget.Cast( layoutRoot.FindAnyWidget("FindItemIcon") ).LoadImageFile(0,"PNH_Missions/gui/images/Find.paa");
		ImageWidget.Cast( layoutRoot.FindAnyWidget("CartCashIcon") ).LoadImageFile(0,"PNH_Missions/gui/images/Cash.paa");
		ImageWidget.Cast( layoutRoot.FindAnyWidget("TraderBankBalanceIconCash") ).LoadImageFile(0,"PNH_Missions/gui/images/Cash.paa");
		ImageWidget.Cast( layoutRoot.FindAnyWidget("CartTotalIcon") ).LoadImageFile(0,"PNH_Missions/gui/images/Bill.paa");
		ImageWidget.Cast( layoutRoot.FindAnyWidget("CartIcon") ).LoadImageFile(0,"PNH_Missions/gui/images/Cart.paa");
		
		ImageWidget.Cast( layoutRoot.FindAnyWidget("ConfirmIcon") ).LoadImageFile(0,"PNH_Missions/gui/images/Confirm.paa");
		ImageWidget.Cast( layoutRoot.FindAnyWidget("EmptyIcon") ).LoadImageFile(0,"PNH_Missions/gui/images/CartEmpty.paa");
