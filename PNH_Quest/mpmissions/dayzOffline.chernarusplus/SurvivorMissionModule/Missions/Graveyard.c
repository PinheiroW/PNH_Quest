class GraveyardMission extends BXD_Missions
{
	...
	void GraveyardMission()
	{
		...
		m_MissionMessage1 = "Acabei de receber a notícia de que o comandante das Tropas de Defesa de Chernarus, General-Major " + SurvivorName + ", não sobreviveu à infecção.";
		m_MissionMessage2 = "Ele foi um dos oficiais do Exército Soviético em Chernarus. " + SurvivorName + " me disse que perdeu mais de 2000 homens aqui e que jamais desistiria da luta contra a infecção enquanto estivesse vivo. Ele foi infectado enquanto ajudava a proteger os moradores de " + m_MissionLocation + ".";
		m_MissionMessage3 = "Ele escondeu alguns equipamentos no cemitério de\n** " + m_MissionLocation + ", " + m_MissionLocationDir + " próximo à igreja **\nAcho que alguém deveria recuperar esse legado. Ele enterrou tudo em algum lugar perto dos túmulos. Você vai precisar de, no mínimo, uma pá. Tome cuidado!";
