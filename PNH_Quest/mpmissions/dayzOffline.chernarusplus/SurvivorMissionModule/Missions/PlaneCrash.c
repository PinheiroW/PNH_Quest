class PlaneCrashMission extends BXD_Missions
{
	...
	void PlaneCrashMission()
	{
		...
		m_MissionMessage1 = "Acabei de receber uma chamada de emergência de um piloto militar. Um dos tripulantes foi infectado e atacou os outros de repente. Ele disse que esse voo tem a mais alta prioridade internacional.";
		m_MissionMessage2 = "A bordo também está o Sr. " + SurvivorName + ", um agente da ONU, e parece que ele tem informações sobre a cura dessa doença pandêmica. Eles estavam a 30 mil pés a caminho do País de Gales.";
		m_MissionMessage3 = "O piloto informou que foi mordido e tentou fazer um pouso de emergência em algum lugar nos campos\n** " + m_MissionLocationDir + " de " + m_MissionLocation + " **\nDescubra se eles conseguiram. Há equipamentos a bordo!";
