class ApartmentMission extends BXD_Missions
{
	...
	void ApartmentMission()
	{
		...
		//Mission messages 
		m_MissionMessage1 = SurvivorName + " foi um dos meus melhores alunos. Eu costumava conversar com ele pelo rádio, mas agora perdi o contato.";
		m_MissionMessage2 = "Ele me disse que escondeu um baú com bons equipamentos em algum lugar nos apartamentos. Há alguns dias, ele barricou todo o prédio contra os infectados.";
		m_MissionMessage3 = "Ele morava em um dos apartamentos\n** " + m_MissionLocationDir + " de " + m_MissionLocation + " **\nPor favor, verifique se " + SurvivorName + " ainda está vivo. Se não estiver, pegue os pertences dele para te ajudar a sobreviver.";
