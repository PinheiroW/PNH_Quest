class PsilosMission extends BXD_Missions
{
	...
	{	
		...
		m_MissionMessage1 = SurvivorName + ", um sobrevivente que conheci há alguns dias, me disse que há alguns locais por aqui com grande ocorrência de um cogumelo especial. O nome científico é 'Psilocybe semilanceata'.";
		m_MissionMessage2 = "Atualmente estou experimentando o ingrediente psicoativo Psilocibina em animais selvagens infectados. Eles demonstram comportamentos curiosos cerca de 30 minutos após a ingestão oral. Ainda não posso dizer muito sobre isso, mas preciso de mais cogumelos para os testes.";
		m_MissionMessage3 = SurvivorName + " disse que encontrou alguns deles em algum lugar\n** " + m_MissionLocationDir + " de " + m_MissionLocation + " **\nPreciso de mais " + ReqShroomsCount + " unidades. Os cogumelos são muito pequenos. Recomendo usar uma enciclopédia de cogumelos para encontrar possíveis locais!";
	...
	void ExtendMission()
	{
		...
		m_MissionMessage1 = "Muito bem, sobrevivente, se você encontrou os " + ReqShroomsCount + " cogumelos, leve-os para o seguinte local. Espere um segundo...";
		m_MissionMessage2 = "Leve-os até a ** Delegacia de Polícia de " + m_MissionDescription[3] + " **\n" + SurvivorExtName + " disse que pode extrair a substância ativa para mim. Ela deixou um pequeno estojo protetor sobre a mesa no escritório.";
		m_MissionMessage3 = "Coloque tudo o que encontrou lá dentro. Tome cuidado, pode haver bandidos por perto que tenham interceptado nossa conversa de rádio. Boa sorte!";
