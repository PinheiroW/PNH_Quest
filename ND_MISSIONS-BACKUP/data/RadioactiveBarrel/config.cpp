				...
				class Health
				{
					...
					healthLevels[]=
					{
						
						{
							...
							{
								"ND_MISSIONS\data\RadioactiveBarrel\alp_barrel_yellow.rvmat"
							}
						},
						...
						
						{
							...
							{
								"ND_MISSIONS\data\RadioactiveBarrel\alp_barrel_yellow_damage.rvmat"
							}
						},
						...
						
						{
							...
							{
								"ND_MISSIONS\data\RadioactiveBarrel\alp_barrel_yellow_destruct.rvmat"
							}
						}
					};
				};
