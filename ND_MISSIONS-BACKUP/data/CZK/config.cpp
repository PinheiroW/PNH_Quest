				...
				class Health
				{
					...
					healthLevels[]=
					{
						
						{
							...
							{
								"ND_MISSIONS\data\CZK\data\coin.rvmat"
							}
						},
						
						{
							...
							{
								"ND_MISSIONS\data\CZK\data\coin_damage.rvmat"
							}
						},
						
						{
							...
							{
								"ND_MISSIONS\data\CZK\data\coin_destruct.rvmat"
							}
						}
					};
				};
				...
				class Health
				{
					...
					healthLevels[]=
					{
						
						{
							...
							{
								"ND_MISSIONS\data\CZK\data\money.rvmat"
							}
						},
						
						{
							...
							{
								"ND_MISSIONS\data\CZK\data\money_damage.rvmat"
							}
						},
						
						{
							...
							{
								"ND_MISSIONS\data\CZK\data\money_destruct.rvmat"
							}
						}
					};
				};
