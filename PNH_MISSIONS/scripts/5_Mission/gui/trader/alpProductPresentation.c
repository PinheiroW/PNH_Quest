...
class alpProductPresentation 
{
	...
	Widget GetPanel()
	{
		Widget layout = GetGame().GetWorkspace().CreateWidgets( "PNH_Missions/gui/layouts/Item.layout"); //, alp_Parent);	
		...
		ImageWidget.Cast( alp_Root.FindAnyWidget("PlusIcon") ).LoadImageFile(0,"PNH_Missions/gui/images/Plus.paa");
		alp_ButtonMinus = ButtonWidget.Cast( layout.FindAnyWidget("ButtonMinus") );
		ImageWidget.Cast( alp_Root.FindAnyWidget("MinusIcon") ).LoadImageFile(0,"PNH_Missions/gui/images/Minus.paa");
		
		alp_IconInCart = ImageWidget.Cast( layout.FindAnyWidget("InCartIcon") );
		alp_IconInCart.LoadImageFile(0,"PNH_Missions/gui/images/Cart.paa");	
		...
		//reputation
		string iconReputation = "PNH_Missions/gui/images/Reputation/r" + GetProductCard().GetRequiredReputation().ToString() + ".paa";	
	...
	void Update()
	{
		...
		{
			alp_IconInStock.LoadImageFile(0,"PNH_Missions/gui/images/Available.paa");	
		...
		{
			alp_IconInStock.LoadImageFile(0,"PNH_Missions/gui/images/UnAvailable.paa");	
