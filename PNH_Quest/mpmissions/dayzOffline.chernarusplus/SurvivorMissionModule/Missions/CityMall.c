class CityMallMission extends BXD_Missions
{
	...
	{		
		...
		m_MissionMessage1 = "A Sra. " + SurvivorName + ", professora do ensino fundamental, me contou que levou algumas crianças de sua turma para um local seguro, longe de suas famílias infectadas. Prometi que ajudaria a conseguir comida e suprimentos médicos para os pequenos.";
		m_MissionMessage2 = "Ontem descobri que o supermercado em\n** " + m_MissionLocation + " **\nestá barricado e provavelmente ainda tem comida lá dentro. Mas havia muitos infectados por perto e não consegui verificar o local.";
		m_MissionMessage3 = "Ela precisa urgentemente dos seguintes itens do mercado:\n- " + ReqFoodAmount + " latas de comida e...\n- " + ReqMedAmount + " pacotes de antibióticos\nPor favor, me ajude a apoiar a Sra. " + SurvivorName + " com esses itens essenciais para as crianças.";
	...
	{	//When player enters mission target zone at primary mission
		...
		m_MissionMessage1 = "Muito bem, você encontrou os suprimentos, agora tente sair de lá em segurança. A Sra. " + SurvivorName + " nunca me contou sua localização exata porque quer estar completamente protegida de bandidos e saqueadores.";
		m_MissionMessage2 = "Acho que o melhor seria se você deixasse os suprimentos na sala silenciosa da pequena delegacia de polícia em\n** "+ m_MissionDescription[3] +" **\ne colocasse tudo na mochila laranja que deixei lá. Vou verificar dentro de uma hora e tentar contatá-la pelo rádio.";
		m_MissionMessage3 = "Tenho algumas coisas para você na pequena delegacia. Tome cuidado, pode haver bandidos nos arredores de "+ m_MissionDescription[3] +". Eles podem ter interceptado nossa conversa. Boa sorte!";
