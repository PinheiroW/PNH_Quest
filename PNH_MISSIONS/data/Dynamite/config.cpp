class CfgPatches
{
	class PNH_Missions_data_dynamite
	{
		units[]=
		{
			"alp_Dynamite"
...
class CfgVehicles
{
	...
	class alp_Dynamite: alp_Dynamite_Base
	{
		...
		model="PNH_Missions\data\dynamite\dynamite.p3d";
		weight=1000;
		itemSize[]={2,3};
		itemBehaviour=1;
		...
		{
			"PNH_Missions\data\dynamite\data\dynamite_CO.paa",
			"PNH_Missions\data\dynamite\data\dynamite_CO.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"PNH_Missions\data\dynamite\data\dynamite.rvmat",
			"PNH_Missions\data\dynamite\data\dynamite.rvmat"
		};
		class DamageSystem
		{
				...
				class Health
				{
					...
					healthLevels[]=
					{
						...
						
						{
							...
							{
								"PNH_Missions\data\dynamite\data\dynamite_damage.rvmat"
							}
						},
						
						{
							...
							{
								"PNH_Missions\data\dynamite\data\dynamite_destruct.rvmat"
							}
						}
					};
				};
