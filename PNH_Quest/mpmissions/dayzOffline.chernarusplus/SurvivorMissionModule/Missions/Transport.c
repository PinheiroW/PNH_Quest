class TransportMission extends BXD_Missions
{
	...
	{		
		...
		m_MissionMessage1 = SurvivorName + ", um cara que trabalhava para mim, disse que cruzou uma cepa especial de Cannabis com várias plantas de 'Cannabis ruderalis'. Eu preciso disso apenas para meus experimentos com os infectados. Ele contou que fertilizou as plantas-mãe com restos triturados de infectados.";
		m_MissionMessage2 = "Acho que ele quis dizer algum tipo de mistura fermentada com água, cinzas de infectados e pedaços de carne, feita num liquidificador de cozinha. O impacto no crescimento e floração das plantas foi enorme. Parece também conter uma substância diferente dos canabinoides comuns. Quero extrair essa substância e ver como ela age nos infectados.";
		m_MissionMessage3 = SurvivorName + " escondeu as ervas dele em uma garagem em\n** " + m_MissionLocation + " **\nEle com certeza trancou as portas da garagem, então tente usar uma gazua ou atire nas fechaduras se não tiver outra opção.";
	...
	{	//When player enters mission target zone at primary mission
		...
		m_MissionMessage2 = "Dirija até o ** Posto de Gasolina " + m_MissionDescription[3] + " **\ne leve a bolsa com a ganja até o balcão. A ganja de " + SurvivorName + " é de máxima prioridade. Por favor, não roube nem fume nada por conta própria — pode ser muito perigoso.";
