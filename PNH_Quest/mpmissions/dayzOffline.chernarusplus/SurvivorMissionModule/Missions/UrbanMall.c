class UrbanMallMission extends BXD_Missions
{	//UrbanMall is a copy of CityMall mission, it has equal functionality but uses different MissionBuilding 
	...
	{		
		...
		m_MissionMessage1 = "A Sra. " + SurvivorName + ", professora do ensino fundamental, me contou que levou algumas crianças da sua turma para um local seguro, longe de suas famílias infectadas. Prometi que ajudaria a conseguir comida e suprimentos médicos para elas.";
		m_MissionMessage2 = "Ontem descobri que o shopping da cidade em\n** " + m_MissionLocation + " **\nestá barricado e provavelmente ainda contém comida. Mas havia muitos infectados por perto e não consegui verificar o local.";
		m_MissionMessage3 = "Ela precisa urgentemente dos seguintes itens:\n- " + ReqFoodAmount + " latas de comida\n- " + ReqMedAmount + " pacotes de antibióticos\nPor favor, me ajude a apoiar a Sra. " + SurvivorName + " com esses itens essenciais para as crianças. Tenha cuidado!";
	...
	{	//When player enters mission target zone at primary mission
		...
		m_MissionMessage1 = "Muito bem, você encontrou os suprimentos. Tente sair de lá com segurança. A Sra. " + SurvivorName + " nunca me contou sua localização porque quer estar totalmente protegida de bandidos e saqueadores.";
		m_MissionMessage2 = "Acho melhor você deixar os suprimentos na sala de refeições da\n** delegacia de polícia de " + m_MissionDescription[3] + " **\ne colocá-los todos na mochila laranja que deixei lá. Vou verificar em uma hora e tentar contatá-la pelo rádio.";
		m_MissionMessage3 = "Vou te dar uma gazua, tente acessar a sala do arsenal e trancá-la. Tudo está lá dentro. Tome cuidado, pode haver bandidos nos arredores de " + m_MissionDescription[3] + ". Eles podem ter interceptado nossa conversa de rádio. Boa sorte!";
