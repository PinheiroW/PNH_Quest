class ShroomsMission extends BXD_Missions
{
	...
	{	
		...
		m_MissionMessage1 = SurvivorName + ", um sobrevivente que conheci há alguns dias, me contou que existem alguns locais por aqui com grande ocorrência de um cogumelo especial. O nome científico é 'Psilocybe semilanceata'.";
		m_MissionMessage2 = "No momento, estou experimentando a substância psicoativa contida nele, a Psilocibina, em animais selvagens infectados. Eles demonstram comportamentos interessantes cerca de 30 minutos após a ingestão oral. Ainda não posso dizer muito, mas para continuar meus experimentos, preciso de mais cogumelos.";
		m_MissionMessage3 = SurvivorName + " disse que encontrou alguns desses cogumelos em algum lugar\n** " + m_MissionLocationDir + " de " + m_MissionLocation + " **\nPreciso de mais " + ReqShroomsCount + " unidades. Os cogumelos são muito pequenos. Recomendo usar uma enciclopédia de cogumelos para ajudar na procura!";
	...
	void ExtendMission()
	{
		...
		m_MissionMessage2 = "Leve-os até o ** Escritório do Hospital de " + m_MissionDescription[3] + " **\n" + SurvivorExtName + " disse que pode extrair a substância ativa para mim. Ela tem um pequeno estojo protetor sobre a mesa no antigo escritório dela.";
