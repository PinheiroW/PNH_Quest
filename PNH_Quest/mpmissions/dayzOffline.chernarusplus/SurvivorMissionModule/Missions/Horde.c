class HordeMission extends BXD_Missions
{
	...
	void HordeMission()
	{
		...
		m_MissionMessage1 = "Recebi uma chamada de emergência de um piloto de helicóptero que caiu em algum lugar nas florestas. Ele está ferido, mas ainda vivo. Estava com medo de que os infectados o encontrassem em breve.";
		m_MissionMessage2 = "Ele conseguiu chegar a uma casa em uma vila próxima ao local da queda. Está bem equipado e pretende passar a noite na casa, tratando seus ferimentos abertos.";
		m_MissionMessage3 = "A casa está localizada no ** " + m_MissionLocationDir + " de " + m_MissionLocation + " **\nTenha cuidado, pode haver infectados e outros sobreviventes interessados no equipamento dele!";
