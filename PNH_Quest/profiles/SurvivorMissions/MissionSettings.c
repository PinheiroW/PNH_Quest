...
{	
	...
	static string ZoneEnterMsg = "Você entrou na zona da missão!";
	static string TimeLeftMsg = " minutos restantes até o fim da missão."; // mantenha o primeiro caractere como espaço
	static string ZoneLeaveMsg = "Você saiu da zona da missão!";
	static string StartingMsg = "Alguém está me ouvindo? Câmbio!"; // (Mensagem 0)
	static string TargetFoundMsg = "Você encontrou o alvo!";
	static string Message3Ext = " minutos restantes. Câmbio, desligo!"; // mantenha o primeiro caractere como espaço
	static string FinishingMsg = "Obrigado, sobrevivente, por resolver isso.\nChamarei você para novas tarefas neste canal de rádio.\nCâmbio, desligo!"; // (Mensagem -1)
