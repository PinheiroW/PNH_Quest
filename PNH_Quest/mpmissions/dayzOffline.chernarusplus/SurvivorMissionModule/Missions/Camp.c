class CampMission extends BXD_Missions
{
	...
	void CampMission()
	{
		...
		m_MissionMessage1 = "Meu amigo " + SurvivorName + " não responde no rádio há 2 horas. Ele é um excelente sobrevivente ao ar livre e estou me perguntando se está tudo bem com ele.";
		m_MissionMessage2 = "A filha dele está infectada. Ele cuida dela às vezes. Cerca de 5 horas atrás, ele me disse que encontrou algumas coisas em casas de " + m_MissionLocation + " e foi atacado no caminho de volta para o acampamento, mas não se feriu.";
		m_MissionMessage3 = "Acho que ele disse que montou sua barraca recentemente\n" + m_MissionLocationDir + " de " + m_MissionLocation + "\nEstou muito preocupado, eu realmente agradeceria se você pudesse ir procurá-lo. Cuidado, ele usa armadilhas para proteger o local!";
