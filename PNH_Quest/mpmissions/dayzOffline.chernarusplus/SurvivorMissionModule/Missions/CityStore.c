class CityStoreMission extends BXD_Missions
{	//CityStore is a copy of UrbanMall mission, it uses another secondary mission building
	...
	{		
		...
		m_MissionMessage2 = "Ontem descobri que a loja da cidade\n** " + m_MissionLocationDir + " de " + m_MissionLocation + " **\nestá barricada e provavelmente ainda tem comida lá dentro. Mas havia muitos infectados por perto e não consegui verificar o local.";
	...
	{	//When player enters mission target zone at primary mission
		...
		m_MissionMessage3 = "Tenho algumas coisas para você na pequena delegacia. Tome cuidado, pode haver bandidos nos arredores de "+ m_MissionSecondaryLoc +". Eles podem ter interceptado nossa conversa. Boa sorte!";
