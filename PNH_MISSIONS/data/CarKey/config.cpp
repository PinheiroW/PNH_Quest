class CfgPatches
{
	class PNH_Missions_data_CarKey
	{
		units[]=
		{
			"alp_CarKey",
...
class CfgVehicles
{
	...
	{
		model="PNH_Missions\data\CarKey\carkey.p3d";
		animClass="Knife";
		rotationFlags=17;
				...
				class Health
				{
					...
					healthLevels[]=
					{
						
						{
							...
							{
								"PNH_Missions\data\CarKey\data\CarKey.rvmat"
							}
						},
						
						{
							...
							{
								"PNH_Missions\data\CarKey\data\carkey_damage.rvmat"
							}
						},
						
						{
							...
							{
								"PNH_Missions\data\CarKey\data\carkey_destruct.rvmat"
							}
						}
					};
				};
	...
	class alp_CarKeyBlue: alp_CarKey
	{
		...
		{
			"PNH_Missions\data\CarKey\data\carkey_blue.paa"
		};
	};
	class alp_CarKeyGreen: alp_CarKey
	{
		...
		hiddenSelectionsTextures[]=
		{
			"PNH_Missions\data\CarKey\data\carkey_green.paa"
		};
	};
	class alp_CarKeyYellow: alp_CarKey
	{
		...
		hiddenSelectionsTextures[]=
		{
			"PNH_Missions\data\CarKey\data\carkey_yellow.paa"
		};
	};
	class alp_CarKeyWhite: alp_CarKey
	{
		...
		hiddenSelectionsTextures[]=
		{
			"PNH_Missions\data\CarKey\data\carkey_white.paa"
		};
	};
	class alp_CarKeyPurple: alp_CarKey
	{
		...
		hiddenSelectionsTextures[]=
		{
			"PNH_Missions\data\CarKey\data\carkey_purple.paa"
		};
	};
	class alp_CarKeyBrown: alp_CarKey
	{
		...
		hiddenSelectionsTextures[]=
		{
			"PNH_Missions\data\CarKey\data\carkey_brown.paa"
		};
	};
};
