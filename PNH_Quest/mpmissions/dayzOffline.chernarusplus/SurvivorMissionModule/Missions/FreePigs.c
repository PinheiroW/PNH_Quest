class FreePigsMission extends BXD_Missions
{
	...
	{		
		...
		m_MissionMessage1 = SurvivorName + ", um fazendeiro de " + m_MissionLocation + ", morreu há 2 dias após um ataque de bandidos. Ele estava protegendo seus animais dos infectados e saqueadores, e criava porcos para entregar carne ao esconderijo de sobreviventes jovens e idosos em algum lugar nas florestas.";
		m_MissionMessage2 = "Ele era bem conhecido entre os sobreviventes por sua perfeição em fazer bacon de qualidade e carne temperada para churrasco. Seus porcos ainda estão no curral, e temo que possam morrer de fome, se já não tiverem sido mortos por infectados ou roubados por bandidos.";
		m_MissionMessage3 = "Vá até a fazenda de " + SurvivorName + " localizada \n** " + m_MissionLocationDir + " de " + m_MissionLocation + " **\ne liberte todos os porcos da gaiola para dar a eles uma chance de sobreviver. Você precisará de, no mínimo, uma faca.";
	...
	{	//When player enters mission target zone at primary mission
		...
		m_MissionMessage1 = "Muito bem, você encontrou os porcos. Tire todos eles do curral. Proteja-os de ataques de infectados e abata 2 porcos para obter carne.";
		m_MissionMessage2 = "Um homem do acampamento de sobreviventes disse que pode ir até um local seguro em alguma parte da floresta para pegar a carne. Deixei uma mochila de caça na mesa de piquenique ao longo da trilha de caminhada.";
		m_MissionMessage3 = "Leve a carne até a mesa de piquenique próxima a\n** " + m_MissionDescription[3] + ", coordenadas: " + Coords + " **\nColoque " + ReqMeatAmount + " bifes de porco dentro da mochila e então poderá pegar o que precisar. Tome cuidado!";
