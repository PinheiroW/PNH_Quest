...
class alpReputationStat extends alpStatBase
{
	...
	void alpReputationStat(WrapSpacerWidget w, float currentRep=0 , float maxRep=0)
    {
        ...
        Widget panel = GetGame().GetWorkspace().CreateWidgets( "PNH_Missions/gui/layouts/reputationStat.layout",w) ;
        //
