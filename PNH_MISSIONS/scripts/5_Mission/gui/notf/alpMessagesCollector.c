...
class alpMessagesCollector 
{
	...
	void InitMessageCollector()
	{
		if ( !alp_Collector )
		{
			...
			{
				case 1:
					messageWindow = GetGame().GetWorkspace().CreateWidgets( "PNH_Missions/gui/layouts/nd_notf_center.layout" ); 
					break;
				case 2:
					messageWindow = GetGame().GetWorkspace().CreateWidgets( "PNH_Missions/gui/layouts/nd_notf_right.layout" ); 
					break;			
				default:
					messageWindow = GetGame().GetWorkspace().CreateWidgets( "PNH_Missions/gui/layouts/nd_notf.layout" ); 						
	...
	{
		Widget messageWindow = GetGame().GetWorkspace().CreateWidgets( "PNH_Missions/gui/layouts/nd_notf_message.layout" );
