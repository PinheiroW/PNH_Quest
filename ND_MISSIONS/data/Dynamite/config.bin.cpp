class CfgPatches
{
	class ND_MISSIONS_data_dynamite
	{
		units[]=
		{
			"alp_Dynamite"
...
class CfgVehicles
{
	...
	class alp_Dynamite: alp_Dynamite_Base
	{
		...
		model="ND_MISSIONS\data\dynamite\dynamite.p3d";
		weight=1000;
		itemSize[]={2,3};
		itemBehaviour=1;
		...
		{
			"ND_MISSIONS\data\dynamite\data\dynamite_CO.paa",
			"ND_MISSIONS\data\dynamite\data\dynamite_CO.paa"
		};
		hiddenSelectionsMaterials[]=
		{
			"ND_MISSIONS\data\dynamite\data\dynamite.rvmat",
			"ND_MISSIONS\data\dynamite\data\dynamite.rvmat"
		};
		class DamageSystem
		{
				...
				class Health
				{
					...
					healthLevels[]=
					{
						...
						
						{
							...
							{
								"ND_MISSIONS\data\dynamite\data\dynamite_damage.rvmat"
							}
						},
						
						{
							...
							{
								"ND_MISSIONS\data\dynamite\data\dynamite_destruct.rvmat"
							}
						}
					};
				};
