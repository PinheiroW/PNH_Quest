class CfgPatches
{
	class PNH_Missions_data_RadioactiveBarrel
	{
		units[]=
		{
			"alp_Barrel_Yellow"
...
class CfgVehicles
{
	...
	class alp_Barrel_Yellow: alp_Radioactive_Barrel
	{
		...
		{
			"PNH_Missions\data\RadioactiveBarrel\alp_barrel_yellow_co.paa"
		};
				...
				class Health
				{
					...
					healthLevels[]=
					{
						
						{
							...
							{
								"PNH_Missions\data\RadioactiveBarrel\alp_barrel_yellow.rvmat"
							}
						},
						...
						
						{
							...
							{
								"PNH_Missions\data\RadioactiveBarrel\alp_barrel_yellow_damage.rvmat"
							}
						},
						...
						
						{
							...
							{
								"PNH_Missions\data\RadioactiveBarrel\alp_barrel_yellow_destruct.rvmat"
							}
						}
					};
				};
