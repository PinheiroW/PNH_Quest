...
modded class IngameHud extends Hud
{
	...
	override void Init( Widget hud_panel_widget )
 	{ 
		...
		Widget radPanel	= GetGame().GetWorkspace().CreateWidgets("PNH_Missions/gui/layouts/radiation.layout",leftHud);
		...
		alp_ChemicalShield.LoadImageFile(0,"PNH_Missions/gui/Images/ToxicShield.paa");
