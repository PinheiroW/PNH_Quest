class BearHuntMission extends BXD_Missions
{
	...
	{	
		...
		m_MissionMessage1 = "Um sobrevivente me informou recentemente que um urso atacou meu amigo " + SurvivorName + " e matou outros 2 sobreviventes. Eles foram para o local errado tentando caçar cervos na floresta de " + m_MissionLocation + ".";
		m_MissionMessage2 = "Ainda não consigo acreditar. " + SurvivorName + " era um dos melhores caçadores por aqui. Uma vez por semana, ele trazia carne fresca para o acampamento escondido, alimentando os sobreviventes. Ele nunca foi egoísta e sempre fazia de tudo para ajudar no acampamento.";
		m_MissionMessage3 = "O urso foi visto pela última vez na floresta próxima\n** " + m_MissionLocationDir + " de " + m_MissionLocation + " **\nQuero que você mate esse animal e pegue sua pele. Não é por vingança, precisamos da pele para fazer roupas de inverno para as crianças. Tenha cuidado!";
	...
	void ExtendMission()
	{
		...
		m_MissionMessage2 = "Pegue sua faca e esviretre o animal. Leve o couro e a carne até o\n** laboratório da escola "+ m_MissionDescription[3] +" **\n(ala esquerda, último andar), pois quero examinar a carne do urso. Deixei uma mochila de caça sobre a mesa do laboratório.";
		m_MissionMessage3 = "Coloque pelo menos "+ ReqMeatAmount +" bifes de urso e o couro dentro da mochila. Tome cuidado, pode haver bandidos por perto que tenham interceptado nossa pequena conversa de rádio. Boa sorte!";
