...
class CfgVehicles
{
				...
				class Health
				{
					...
					healthLevels[]=
					{
						
						{
							...
							{
								"ND_MISSIONS\data\CarKey\data\CarKey.rvmat"
							}
						},
						
						{
							...
							{
								"ND_MISSIONS\data\CarKey\data\carkey_damage.rvmat"
							}
						},
						
						{
							...
							{
								"ND_MISSIONS\data\CarKey\data\carkey_destruct.rvmat"
							}
						}
					};
				};
	...
	class alp_CarKeyBlue: alp_CarKey
	{
		...
		{
			"ND_MISSIONS\data\CarKey\data\carkey_blue.paa"
		};
	};
	class alp_CarKeyGreen: alp_CarKey
	{
		...
		hiddenSelectionsTextures[]=
		{
			"ND_MISSIONS\data\CarKey\data\carkey_green.paa"
		};
	};
	class alp_CarKeyYellow: alp_CarKey
	{
		...
		hiddenSelectionsTextures[]=
		{
			"ND_MISSIONS\data\CarKey\data\carkey_yellow.paa"
		};
	};
	class alp_CarKeyWhite: alp_CarKey
	{
		...
		hiddenSelectionsTextures[]=
		{
			"ND_MISSIONS\data\CarKey\data\carkey_white.paa"
		};
	};
	class alp_CarKeyPurple: alp_CarKey
	{
		...
		hiddenSelectionsTextures[]=
		{
			"ND_MISSIONS\data\CarKey\data\carkey_purple.paa"
		};
	};
	class alp_CarKeyBrown: alp_CarKey
	{
		...
		hiddenSelectionsTextures[]=
		{
			"ND_MISSIONS\data\CarKey\data\carkey_brown.paa"
		};
	};
};
