class GanjaMission extends BXD_Missions
{
	...
	{		
		...
		m_MissionMessage1 = SurvivorName + ", um cara que trabalhava para mim, disse que criou uma cepa especial de Cannabis cruzando várias plantas de 'Cannabis ruderalis'. Eu preciso disso apenas para meus experimentos com os infectados. Ele disse que fertilizou as plantas-mãe com restos triturados de infectados.";
		m_MissionMessage2 = "Acho que ele quis dizer algum tipo de mistura fermentada com água, cinzas de infectados e pedaços de carne feita num liquidificador de cozinha. O impacto no crescimento e na floração das plantas foi enorme. Parece também que contém uma substância diferente dos canabinoides comuns. Quero extrair essa substância para ver como ela age nos infectados.";
		m_MissionMessage3 = SurvivorName + " escondeu suas ervas em uma garagem em\n** " + m_MissionLocation + " **\nEle certamente trancou as portas da garagem, então tente usar um arrombador ou atire nas fechaduras se não tiver outro jeito.";
	...
	{	//When player enters mission target zone at primary mission
		...
		m_MissionMessage1 = "Muito bem, então você encontrou o carro. " + SurvivorName + " provavelmente drenou todo o combustível e óleo, então prepare o carro antes dessa longa viagem. Verifique se a Cannabis seca está em alguma das garagens por ali, pegue a bolsa e coloque as 25 unidades dentro.";
		m_MissionMessage2 = "Dirija até o ** Posto de Gasolina " + m_MissionDescription[3] + " **\ne leve a bolsa com a ganja até o caixa. A ganja de " + SurvivorName + " é de alta prioridade. Por favor, não roube nem fume nada por conta própria — pode ser muito perigoso.";
		m_MissionMessage3 = "Tenho algumas coisas para você no posto de gasolina. Tome cuidado, pode haver bandidos a caminho de " + m_MissionDescription[3] + ". Eles podem ter interceptado nossa conversa. Boa sorte e dirija com cuidado!";
